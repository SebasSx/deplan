			...
			public void onEntrada(Object entrada, View view) {
		        if (entrada != null) {
		            ...
		            if (texto_superior_entrada != null) 
		            	texto_superior_entrada.setText(((Lista_contenido.Lista_entrada) entrada).titulo); 
		            
		            TextView texto_inferior_entrada = (TextView) view.findViewById(R.id.fecha_lista); 
		            if (texto_inferior_entrada != null) 
		            	texto_inferior_entrada.setText(((Lista_contenido.Lista_entrada) entrada).fechaHora); 
		            
		            
		            ImageView imagen_entrada = (ImageView) view.findViewById(R.id.imageView_imagen_miniatura); 
		            if (imagen_entrada != null)
		            	imagen_entrada.setImageResource(((Lista_contenido.Lista_entrada) entrada).image);
		        }
			}
		});
